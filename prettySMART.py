...
AllowedTSpans = [
    ...
    ["#C0C0C0", "Arial", "24.000"],
    ["#C0C0C0", "Arial", "28.000"],
    ["#C0C0C0", "Arial", "18.000", "bold"],
    ["#C0C0C0", "Arial", "20.000", "bold"],
    ["#C0C0C0", "Arial", "24.000", "bold"],
    # SR
    ...
    ["#000000", "Arial", "8.000"],
    # Coding
    ["#C0C0C0", "Courier New", "18.000"],
    ["#C0C0C0", "Courier New", "20.000"],
    ["#C0C0C0", "Courier New", "24.000"],
    ["#C0C0C0", "Courier New", "28.000"],
    ["#C0C0C0", "Courier New", "18.000", "bold"],
    ["#C0C0C0", "Courier New", "20.000", "bold"],
    ["#C0C0C0", "Courier New", "24.000", "bold"],
    ["#C0C0C0", "Courier New", "28.000"],
    ...
    for tspan in t.iter():
        ...
        if "font-size" in tspan.attrib:
           ...
           ##     tspan.attrib["font-size"] = tspan.attrib["font-size"].split(".")[0] + ".000"
            ...
            if tspan.attrib["font-size"] in ["28.000", "36.000"] and tspan.attrib["font-family"] in "Arial":
            ...
            if tspan.attrib["font-size"] in ["18.000", "20.000", "24.000"] and tspan.attrib["font-family"] in "Arial":
                tspan.attrib["font-size"] = "24.000" and tspan.attrib["fill"] == "#00005E"

            if tspan.attrib["font-size"] in ["18.000", "24.00", "28.00"] and tspan.attrib["font-family"] in "Courier New":
